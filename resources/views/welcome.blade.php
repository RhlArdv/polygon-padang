    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function buildPopup(item, layerData) {
                ...
                return `
                    <div class="flex flex-col min-w-[220px] bg-white rounded-xl overflow-hidden">
                        <div class="px-4 pt-4 pb-2">
                            <div class="flex items-center gap-1.5 mb-1.5">
                                <span class="w-2 h-2 rounded-full" style="background-color: ${layerData.warna}"></span>
                                <span class="text-[10px] font-medium text-gray-500 uppercase tracking-wide">${layerData.nama}</span>
                            </div>
                            <h4 class="text-base font-semibold text-gray-900 leading-snug">${item.judul}</h4>
                        </div>
                        <div class="px-4 pb-4 flex flex-col gap-3">
                            <div class="flex items-start gap-1.5 text-xs text-gray-500">
                                ...
                                <span class="line-clamp-2 leading-relaxed">${kecamatans}</span>
                            </div>
                            <a href="/item/${item.id}" class="mt-2 flex items-center justify-center w-full px-4 py-2.5 text-xs font-semibold bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors shadow-sm" style="color: #ffffff !important; text-decoration: none;">
                                Lihat Detail
                            </a>
                        </div>
                    </div>
